...
import EstablishmentFormModal from '../Establecimientos/EstablishmentFormModal';
...
import SuscripcionesList from '../Suscripciones/SuscripcionesList';
              ...
              <div className="est-filters-section">
                ...
                >
                  <div className="est-filters-title">
                    ...
                    {activeEstFiltersCount > 0 && <span className="est-filters-badge">{activeEstFiltersCount}</span>}
                  </div>
                  <span className={`est-filters-chevron ${estFiltersOpen ? 'open' : ''}`}>▼</span>
                </div>
                ...
                <div className={`est-filters-body ${estFiltersOpen ? 'open' : ''}`}>
                  ...
                  {/* Card 2: Contacto y Gestión */}
                  <div className="est-fcard">
                    <div className="est-fcard-header">
                      <span className="est-fcard-icon contact">📞</span>
                      <span className="est-fcard-title">Contacto y Gestión</span>
                    </div>
                    <div className="est-fcard-body">
                  ...
                  <div className="est-fcard">
                    ...
                    <div className="est-fcard-body">
                      <div className="est-fcard-grid cols-3">
                        ...
                        <div className="est-ffield-date">
                          <label>🔄 Reinicio de Actividades</label>
                          <div className="est-date-pair">
                            <input
                              type="date"
                        ...
                        <div className="est-ffield-date">
                          <label>🔴 Cierre de Establecimiento</label>
                          <div className="est-date-pair">
                            <input
                              type="date"
